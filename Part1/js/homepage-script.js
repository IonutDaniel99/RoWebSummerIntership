...
$(document).ready(function(){
    $("#LearnMore1").click(function(){
        ...
        $("#Rotate-Square-Image-One").slideToggle("slow");
        $("#content2").slideUp("slow");
        $("#Rotate-Square-Image-Two").slideUp("slow");
        $("#content3").slideUp("slow");      
        $("#Rotate-Square-Image-Three").slideUp("slow"); 
    });
});
$(document).ready(function(){
    $("#LearnMore2").click(function(){
        $("#content1").slideUp("slow");
        $("#Rotate-Square-Image-One").slideUp("slow");
        $("#content2").slideToggle("slow");
        $("#Rotate-Square-Image-Two").slideToggle("slow");
        $("#content3").slideUp("slow");
        $("#Rotate-Square-Image-Three").slideUp("slow");
    });
});
$(document).ready(function(){
    $("#LearnMore3").click(function(){
        ...
        $("#Rotate-Square-Image-Three").slideToggle("slow");
      });
});
